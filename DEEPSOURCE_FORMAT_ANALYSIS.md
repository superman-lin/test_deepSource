...
- **文档说明**：*"Code formatters automatically format your code on every **pull request**"*、*"When enabled, every **pull request** will be checked automatically."*
...
- **文档说明**：*"If changes are made directly to the default branch without a pull request, DeepSource automatically generates a **new pull request** with the necessary formatting changes."*
...
- 文档提到：*"Dashboard configuration is the **default**"*、*"TOML-based configuration is an **optional alternative**"*。
